...
export const roteiro: evento[] = [
  ...
  {adicionarPersonagem: {nome: "irmão", endereco: personagens.irmao, posicao: "direita"}, esperarTempo: 500},
  {virarSpritePersonagem: "protagonista", esperarTempo: 500},
  {escreverMensagem: "Clebim:\nCleitão?! O que você está fazendo aqui?"},
  {virarSpritePersonagem: "irmão"},
