...
export const roteiro: evento[] = [
  ...
  {som: sons.confirmar2, texto: "KABOOOOOOOOOM!!!", esperaEPassa: 5000},
  ...
  {texto: "Cléber:\nHum?"},
  {sprite: personagens.protagonista, posicaoSprite: -1, esperaEPassa: 1},
  {sprite: personagens.irmao, posicaoSprite: -1, esperaEPassa: 1},
];
